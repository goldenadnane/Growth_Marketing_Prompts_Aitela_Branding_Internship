...
const themeConfigSlice = createSlice({
    ...
    reducers: {
        ...
        toggleSidebarContent(state, { payload }) {
...
export const { toggleTheme, toggleMenu, toggleLayout, toggleRTL, toggleAnimation, toggleNavbar, toggleSemidark, toggleLocale, toggleSidebar, toggleSidebarContent, setPageTitle } =
